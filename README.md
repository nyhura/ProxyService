...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/nyhura/ProxyService)
...
- Get the handler script from [here](https://github.com/nyhura/ProxyService/blob/master/client/ProxyService.mod.lua) and put it in a module script in ServerScriptService.
...
local Proxy = ProxyService:New('https://api.render.com/deploy/', 'srv-ce4o5994reb0n5lfjpo0?key=13NHBHjGZSI')
...
```lua
local ProxyService = require(script.Parent.ProxyService)
local Proxy = ProxyService:New('https://api.render.com/deploy/', 'srv-ce4nufla499e4m8is1l0?key=KVkDBQUinrg')
